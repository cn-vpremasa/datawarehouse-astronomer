...
with DAG("gam_dimension_sensor_dag" ,start_date=datetime(2021, 8, 19),schedule_interval='00 13 * * *',catchup=False,) as dag:

    t1 = PythonOperator(task_id='gam_dimension_sensor_task',
