...
with DAG("gam_fact_sensor_dag" ,start_date=datetime(2021, 8, 19),schedule_interval='30 13 * * *',catchup=False,) as dag:

    t1 = PythonOperator(task_id='gam_fact_sensor_task',
                        python_callable=Criteria,
                        op_args=(CONFIG['gam_fact_src_list_dict'],CONFIG['gam_fact_sql_query']))
