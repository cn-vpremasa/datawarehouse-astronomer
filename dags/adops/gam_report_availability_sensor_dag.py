...
with DAG("gam_report_availability_sensor_dag" ,start_date=datetime(2021, 8, 19),schedule_interval='00 13 * * *',catchup=False,) as dag:

    t1 = PythonOperator(task_id='gam_report_availability_sensor_task',
