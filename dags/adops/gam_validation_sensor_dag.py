...
with DAG("gam_validation_sensor_dag" ,start_date=datetime(2021, 8, 19),schedule_interval='30 12 * * *',catchup=False,) as dag:

    t1 = PythonOperator(task_id='gam_validation_sensor_task',
