...
with DAG("staq_fact_sensor_dag" ,start_date=datetime(2021, 8, 19),schedule_interval='15 15 * * *',catchup=False,) as dag:


    t1 = PythonOperator(task_id='staq_fact_sensor_task',
                        python_callable=Criteria,
                        op_args=(CONFIG['staq_fact_src_list_dict'],CONFIG['staq_fact_sql_query']))
