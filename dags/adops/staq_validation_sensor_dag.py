...
with DAG("staq_validation_sensor_dag" ,start_date=datetime(2021, 8, 19),schedule_interval='30 12 * * *',catchup=False,) as dag:
    ...
    t2 = PythonOperator(task_id='staq_validation_sensor_task_2',
                        python_callable=Criteria,
                        op_args=(CONFIG['staq_val_src_list_dict_2'], CONFIG['staq_stand_sql_query_2']))
